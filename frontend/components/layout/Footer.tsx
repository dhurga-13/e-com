...
export default function Footer() {
  return (
    <footer className="w-full bg-[#222] text-[#999] text-[14px] overflow-x-hidden">
      {/* Top Newsletter Section */}
      <div className="border-b border-gray-700">
        <div className="max-w-[1540px] mx-auto px-8 py-12 lg:py-16">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="flex-1 text-center lg:text-left">
              <h4 className="text-[20px] font-bold text-white mb-2">
      ...
      <div className="max-w-[1540px] mx-auto px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          {/* About */}
          <div>
            <h3 className="text-white text-[24px] font-extrabold mb-6">
              RIODE
            </h3>
            <p className="leading-relaxed mb-6">
              Riode eCommerce Template is an excellent and modern template to
              build an amazing e-store.
            </p>
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="w-9 h-9 rounded-full border border-gray-600 flex items-center justify-center hover:text-white hover:border-[#2d5eff] hover:bg-[#2d5eff] transition-all"
              >
                <Facebook size={16} />
              </a>
              <a
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <a href="#" className="hover:text-[#2d5eff] transition-colors">
                  Help Center
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5">
              ...
              <li className="flex gap-4 items-center pr-4">
                <Mail size={20} className="text-[#2d5eff] shrink-0" />
                <a
                  href="mailto:mail@riode.com"
                  className="hover:text-[#2d5eff] transition-colors min-w-0 break-words"
                >
                  mail@riode.com
                </a>
              </li>
      ...
      <div className="border-t border-gray-700 py-6">
        <div className="max-w-[1540px] mx-auto px-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            {/* Dummy Payment Icons */}
            <div className="w-10 h-6 bg-[#333] rounded flex items-center justify-center text-[10px] text-white">
              VISA
            </div>
            <div className="w-10 h-6 bg-[#333] rounded flex items-center justify-center text-[10px] text-white">
              MC
