...
const customers = [
  { id: "CUST-1042", name: "John Doe", email: "john.doe@example.com", phone: "+1 (555) 123-4567", orders: 12, spent: "$1,250.00", status: "Active", joined: "Jan 15, 2024" },
  { id: "CUST-1043", name: "Jane Smith", email: "jane.smith@example.com", phone: "+1 (555) 987-6543", orders: 4, spent: "$450.00", status: "Active", joined: "Feb 22, 2024" },
  { id: "CUST-1044", name: "Michael Brown", email: "m.brown@example.com", phone: "+1 (555) 456-7890", orders: 0, spent: "$0.00", status: "Inactive", joined: "Mar 05, 2024" },
  { id: "CUST-1045", name: "Emily Davis", email: "emily.d@example.com", phone: "+1 (555) 234-5678", orders: 28, spent: "$3,450.00", status: "VIP", joined: "Nov 12, 2023" },
  { id: "CUST-1046", name: "David Wilson", email: "david.w@example.com", phone: "+1 (555) 876-5432", orders: 2, spent: "$120.00", status: "Active", joined: "Apr 10, 2024" },
  { id: "CUST-1047", name: "Sarah Taylor", email: "sarah.t@example.com", phone: "+1 (555) 345-6789", orders: 7, spent: "$890.00", status: "Active", joined: "Dec 05, 2023" },
];
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
          <p className="text-sm text-gray-500">Showing <span className="font-medium text-gray-900">1</span> to <span className="font-medium text-gray-900">6</span> of <span className="font-medium text-gray-900">1,240</span> results</p>
          <div className="flex gap-1">
            ...
            <button className="px-3 py-1 border border-gray-200 rounded text-sm text-gray-600 hover:bg-gray-50">...</button>
